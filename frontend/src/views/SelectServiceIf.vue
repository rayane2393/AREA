<template>
  <div class="background">
    <div class="home">
      ...
      <div class="title-page">Select a Service for your Action</div>
      <div class="service-container">
        <div v-for="service in servicesWithActions" :key="service.name" class="service-rectangle" @click="selectService(service.name)">
...
export default {
  ...
  computed: {
    servicesWithActions() {
      return this.services.filter((service) => service.actions && service.actions.length > 0);
    },
  },
  mounted() {
    this.getServices();
  ...
  methods: {
    ...
    selectService(serviceName) {
      localStorage.setItem('selectedServiceActionTMP', serviceName);
