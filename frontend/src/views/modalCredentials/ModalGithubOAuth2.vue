<template>
  <div class="modal">
    ...
    <img style="width: 30px; height: 30px;" src="../../assets/github.svg" alt="Logo Gitub" />
      <h2 class="modal-title">GitHub OAuth2 API</h2>
      ...
      <div class="form-group">
        <label for="oauth_redirect_url">Github Server</label>
        <input type="text" id="oauth_redirect_url" v-model="oauthRedirectUrl" />
      </div>
...
export default {
  data() {
    return {
      cred_name: "GitHub OAuth2 Account", //TODO: put  number if is already exist
      clientId: "73f3807788ba3d1d3dba",
      clientSecret: "dff4bafc78f3962f23cfbfe65bb18bd936de0859",
      oauthCallbackUrl: "http://localhost:8080/list-credentials",
      oauthRedirectUrl: "https://api.github.com",
    };
  },
